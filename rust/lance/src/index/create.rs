...
impl<'a> CreateIndexBuilder<'a> {
    ...
    pub async fn execute_uncommitted(&mut self) -> Result<IndexMetadata> {
        ...
        // Under the segmented-index architecture, segment UUIDs are generated by
        // Lance so distributed workers never write to the same on-disk segment
        // directory.
...
mod tests {
    ...
    async fn test_commit_existing_index_supports_local_hnsw_segments() {
        ...
        // Vector indexes no longer accept a user-specified UUID; capture the
        // segment UUID generated by Lance from the returned metadata.
